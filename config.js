...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Shefin Kl14' : process.env.OWNER_NAME,
    ...
    BOT_PRESENCE: process.env.BOT_PRESENCE === undefined ? 'false' : process.env.BOT_PRESENCE,
    ...
    BRANCH: 'master',
    DEVELOPER: 'Shefin Kl14',
    AUTHOR: 'Shefin Kl14',
    GIT: 'https://github.com/shefinkl14/WhatsAlexa.git',
    HEROKU: {
